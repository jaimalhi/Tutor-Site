...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="carousel svelte-1c1rs61"><div class="carousel-track svelte-1c1rs61">${each(duplicatedSubjects, (subject) => {
    return `<div class="${escape(null_to_empty(`carousel-item card ${subject.color} p-5 m-2 shadow-md w-32 md:w-48`), true) + " svelte-1c1rs61"}"><div class="card-body justify-center items-center text-center"><img${add_attribute("src", subject.icon, 0)}${add_attribute("alt", subject.name, 0)} class="md:mb-2 max-w-12 md:max-w-16"> <h2 class="card-title text-base md:text-xl">${escape(subject.name)}</h2></div> </div>`;
  })}</div> </div>`;
});
const css$1 = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return ` <div class="hero min-h-screen place-items-start items-center svelte-vpx1rj" id="hero-head"><div class="hero-overlay bg-opacity-60"></div> <div class="hero-content text-left text-neutral-content ml-12"><div class="max-w-md text-base-100"><p class="text-black mb-5 bg-blue-200 rounded-md px-4 w-max" data-svelte-h="svelte-45f5m8">Online Private Tutoring</p> <h1 class="mb-5 text-5xl font-bold">Find the perfect tutor for ${validate_component(TypingEffect, "TypingEffect").$$render($$result, {}, {}, {})}</h1> <a href="/how-it-works" class="btn btn-primary px-6 text-base-100" data-svelte-h="svelte-18683wp">Get Started ➞</a></div></div></div>  <div class="separator-top svelte-vpx1rj"></div> <div class="mx-1" style="background-color: #ebebeb; width: 100vw"><p class="text-center text-primary font-semibold mb-1" data-svelte-h="svelte-59ur2d">Subjects</p> <h1 class="text-center text-3xl md:text-4xl font-bold mb-4" data-svelte-h="svelte-3ulbow">Specialized education in a variety of subjects</h1> ${validate_component(Carousel, "Carousel").$$render($$result, {}, {}, {})}</div> <div class="separator-bottom svelte-vpx1rj"></div>  <div class="flex flex-col justify-center items-center mt-14 mb-32">${validate_component(InfoCard, "InfoCard").$$render($$result, { props: infoCard1 }, {}, {})} <div class="md:mb-32"></div> <hr class="flex w-10/12 border-t-2 border-pink-300 my-12 md:hidden"> ${validate_component(InfoCard, "InfoCard").$$render($$result, { props: infoCard2 }, {}, {})} </div>`;
});
export {
  Page as default
};
